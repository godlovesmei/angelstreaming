<nav id="navbar" class="fixed top-8 left-0 right-0 z-50 mx-auto max-w-5xl bg-white/5 backdrop-blur-lg rounded-full
    shadow-lg flex items-center justify-between px-20 py-2 transition-all duration-300 transition-transform">
    <div class="flex items-center flex-1">
        <div class="text-xl font-bold text-[#9ABAFF]">AngelStream</div>
    </div>
    <ul class="flex gap-6 text-white font-medium text-sm flex-1 justify-center">
        ...
        <li><a href="{{ route('login') }}" class="cursor-pointer hover:text-[#9ABAFF] transition-colors duration-200">Browse</a></li>
